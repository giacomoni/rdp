 ...
 */
class INET_API RdpMarkStateVariables : public RdpStateVariables
{
  public:
    RdpMarkStateVariables();
  public:
    double alpha;
 ...
 */
class INET_API RdpMark : public RdpAlgorithm
{
  protected:
    RdpMarkStateVariables *& state;    // alias to TCLAlgorithm's 'state'
  ...
  protected:
    ...
    {
        return new RdpMarkStateVariables();
    }
