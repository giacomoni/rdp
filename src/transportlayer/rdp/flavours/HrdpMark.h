...
#ifndef TRANSPORTLAYER_RDP_FLAVOURS_HRDPMARK_H_
#define TRANSPORTLAYER_RDP_FLAVOURS_HRDPMARK_H_
 ...
 */
class INET_API HrdpMarkStateVariables : public RdpStateVariables
{
  public:
    HrdpMarkStateVariables();
  public:
    double alpha;
    double gamma; //TODO ALLOW ENTRY THROUGH NED

    double increaseFactor;
    simtime_t lastCongestionEvent;
 ...
 */
class INET_API HrdpMark : public RdpAlgorithm
{
  protected:
    HrdpMarkStateVariables *& state;    // alias to TCLAlgorithm's 'state'
  ...
  protected:
    ...
    {
        return new HrdpMarkStateVariables();
    }
...
#endif // ifndef __INET_HrdpMark_H
